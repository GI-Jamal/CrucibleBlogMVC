...
namespace CrucibleBlogMVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(50, ErrorMessage = "The {0} must be at least {2} and the max {1} characters long.", MinimumLength = 2)]
